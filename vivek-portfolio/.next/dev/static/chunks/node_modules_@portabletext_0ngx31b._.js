...
const MONOSPACE_FONT_FAMILY_REGEX = /font-family\s*:[^;]*(?:\bmonospace\b|courier|consolas|menlo|monaco|roboto mono|source code pro|fira code|fira mono|jetbrains mono|ibm plex mono|ubuntu mono)/i;
function hasMonospaceFontFamily(el) {
    const style = isElement(el) && el.getAttribute("style");
    return style ? MONOSPACE_FONT_FAMILY_REGEX.test(style) : !1;
}
function hasPreservedWhitespaceStyle(el) {
    const style = isElement(el) && el.getAttribute("style");
    return style ? /white-space\s*:\s*(?:pre|pre-wrap|break-spaces)/.test(style) : !1;
}
...
function preprocessWhitespace(_, doc) {
    function processNode(node) {
        if (node.nodeType === _XPathResult.BOOLEAN_TYPE && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRESERVE_WHITESPACE_TAGS"].includes(node.parentElement?.tagName.toLowerCase() || "") && // Whitespace inside monospace elements that also declare a
        ...
        !(node.parentElement && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasMonospaceFontFamily"])(node.parentElement) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasPreservedWhitespaceStyle"])(node.parentElement))) {
...
function isMonospaceParagraph(el) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElement"])(el) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tagName"])(el) !== "p") return !1;
    const spans = Array.from(el.querySelectorAll("span")).filter((span)=>(span.textContent ?? "").trim() !== "");
    return spans.length > 0 && spans.every(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasMonospaceFontFamily"]);
}
function isBlankParagraph(el) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElement"])(el) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tagName"])(el) === "p" && (el.textContent ?? "").trim() === "";
}
    ...
    return [
        {
            ...
            deserialize (el, _next, createBlock) {
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElement"])(el) || !isGoogleDocs(el) || !isRootNode(el) || !isMonospaceParagraph(el) || !schemaCanHoldCode) return;
                if (findAdjacentMonospaceParagraph(el, "previous")) return [];
                const lines = [
                    el.textContent ?? ""
                ];
                let pendingBlankLines = 0, sibling = el.nextElementSibling;
                for(; sibling;){
...
`)
        ...
        },
        {
            ...
            deserialize (el) {
                if (!(!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElement"])(el) || !isGoogleDocs(el) || !isRootNode(el) || !isBlankParagraph(el) || !schemaCanHoldCode)) return findAdjacentMonospaceParagraph(el, "previous") && findAdjacentMonospaceParagraph(el, "next") ? [] : void 0;
            }
        },
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElement"])(el) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tagName"])(el) === "span" && isGoogleDocs(el)) {
                    ...
                    return isStrong$1(el) && span.marks.push("strong"), isUnderline$1(el) && span.marks.push("underline"), isStrikethrough(el) && span.marks.push("strike-through"), isEmphasis$1(el) && span.marks.push("em"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasMonospaceFontFamily"])(el) && schema.decorators.some((decorator)=>decorator.name === "code") && span.marks.push("code"), span;
                }
            }
        },
        {
    ...
    return [
        whitespaceTextNodeRule,
        {
            ...
            deserialize (el, _next, createBlock) {
                ...
                const text = el.textContent || "", codeObject = options.matchers?.code?.({
                    context: {
                        schema,
                        keyGenerator: options.keyGenerator ?? keyGenerator
                    },
                ...
                if (codeObject !== void 0) return createBlock(codeObject);
                const isCodeEnabled = schema.decorators.some((decorator)=>decorator.name === "code");
                return {
                    _type: "block",
                    style: "normal",
                    markDefs: [],
...
function toSchemaMatchers(types) {
    const imageMatcher = types?.image, codeMatcher = types?.code ?? codeBlockMatcher;
    if (!imageMatcher && !codeMatcher) return;
    const matchers = {};
    if (imageMatcher) {
        const adaptImage = (isInline)=>({ context, props })=>{
...
\`\`\``, DefaultHorizontalRuleRenderer = ()=>"---", DefaultHtmlRenderer = ({ value })=>value.html, DefaultImageRenderer = ({ value })=>{
    ...
    const getCellText = (cellBlocks)=>cellBlocks.map((block, index)=>renderNode({
        ...
        return `| ${padded.join(" | ")} |`;
    }, renderRow = (cells)=>renderCells(cells.map((cell)=>escapeTableCell(getCellText(cell.value)))), delimiter = `|${Array.from({
        length: columnCount
    }, (_, index)=>{
...
function isEmptyTableRow(cells, context) {
    return cells.every((cell)=>cell.value.every((block)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextBlock"])(context, block) && block.children.every((child)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSpan"])(context, child) && (child.text ?? "").trim() === "")));
}
...
const decorateListener = ({ sendBack, input })=>input.editor.registerBehavior({
    ...
    states: {
        ...
        "decorator added": {
            exit: [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$assign$2d$393c348f$2e$development$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
...
function createPortableTextMemberSchemaTypesFromOf(rootPortableTextType, of) {
    ...
    const inlineObjectTypes = ofType.filter((memberType)=>memberType.name !== "span") || [], blockObjectTypes = of.filter((field)=>field.name !== blockType.name) || [];
    return {
...
function getSanitySubSchema(rootPortableTextType, value, path) {
    ...
    return createPortableTextMemberSchemaTypesFromOf(rootPortableTextType, enclosingOf ?? rootPortableTextType.of ?? []);
}
function resolveEnclosingOf(rootPortableTextType, value, path) {
    ...
    for(let segmentIndex = 0; segmentIndex <= parentKeyedIndex; segmentIndex++){
        ...
        let childNode;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isKeySegment"])(segment)) childNode = currentChildren.find((child)=>child._key === segment._key);
...
function findParentKeyedIndex(path) {
    ...
    for(let index = 0; index < path.length; index++){
        ...
        segment !== void 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isKeySegment"])(segment) && (parentKeyedIndex = lastKeyedIndex, lastKeyedIndex = index);
    }
...
function findChildArrayField(member) {
    ...
    if (fields) {
        for (const field of fields)if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isArraySchemaType"])(field.type)) return {
            name: field.name,
            type: field.type
        };
    }
...
function sanitySchemaTypeToSchema(portableTextType) {
    ...
    const inlineObjectTypes = ofType.filter((memberType)=>memberType.name !== "span") || [], blockObjectTypes = portableTextType.of?.filter((field)=>field.name !== blockType.name) || [], styles = resolveEnabledStyles(blockType), decorators = resolveEnabledDecorators(spanType), lists = resolveEnabledListItems(blockType), annotations = spanType.annotations, conversion = {
        ...
        annotations: annotations.map((annotation)=>{
            const built = buildFields(conversion, annotation.fields, void 0, annotation);
        ...
        blockObjects: blockObjectTypes.map((blockObject)=>{
            const built = buildFields(conversion, blockObject.fields, blockObject.name);
            return pendingWork.push(built.work), {
        ...
        inlineObjects: inlineObjectTypes.map((inlineObject)=>{
            const built = buildFields(conversion, inlineObject.fields, inlineObject.name, inlineObject);
            return pendingWork.push(built.work), {
...
function drain(conversion) {
    let steps = 0;
    for(; conversion.work.length > 0;)if (conversion.work.pop()(), ++steps > 1e8) throw new Error(`Portable Text schema conversion exceeded ${steps} work items; the schema type graph likely contains a cycle the conversion cannot cut (in-flight ancestors: [${[
        ...conversion.ancestors.keys()
    ].join(", ")}])`);
}
    ...
    return {
        ...
        work: ()=>{
            if (inFlightKey !== void 0) {
                ...
                entrySizes === void 0 ? conversion.inFlight.set(inFlightKey, [
                    ancestorCount
                ]) : entrySizes.push(ancestorCount), conversion.work.push(()=>{
...
function compileType(rawType) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Schema"].compile({
        name: "blockTypeSchema",
        types: [
            rawType,
            ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_internal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["builtinTypes"]
        ]
    }).get(rawType.name);
}
;
}),
"[project]/node_modules/@portabletext/sanity-bridge/node_modules/@sanity/types/lib/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** @internal */ function isReference(reference) {
...
/** @beta */ function isCrossDatasetReference(reference) {
...
/** @public */ function isSanityDocument(document) {
    return isObject(document) && typeof document._id == "string" && typeof document._type == "string";
}
/** @public */ function isTypedObject(obj) {
    return isObject(obj) && typeof obj._type == "string";
}
/** @public */ function isKeyedObject(obj) {
    return isObject(obj) && typeof obj._key == "string";
}
/** @beta */ function isGlobalDocumentReference(reference) {
    return !isObject(reference) || typeof reference._ref != "string" ? !1 : reference._ref.split(":").length === 3;
}
/** @internal */ function isValidationErrorMarker(marker) {
    return marker.level === "error";
}
/** @internal */ function isValidationWarningMarker(marker) {
    return marker.level === "warning";
}
/** @internal */ function isValidationInfoMarker(marker) {
...
/** @internal */ function isCreateMutation(mutation) {
    return "create" in mutation;
}
/** @internal */ function isCreateIfNotExistsMutation(mutation) {
    return "createIfNotExists" in mutation;
}
/** @internal */ function isCreateOrReplaceMutation(mutation) {
    return "createOrReplace" in mutation;
}
/** @internal */ function isDeleteMutation(mutation) {
    return "delete" in mutation;
}
/** @internal */ function isPatchMutation(mutation) {
    return "patch" in mutation;
}
const reKeySegment = /_key\s*==\s*['"](.*)['"]/, reIndexTuple = /^\d*:\d*$/;
/** @internal */ function isIndexSegment(segment) {
    return typeof segment == "number" || typeof segment == "string" && /^\[\d+\]$/.test(segment);
}
/** @internal */ function isKeySegment(segment) {
    return typeof segment == "string" ? reKeySegment.test(segment.trim()) : typeof segment == "object" && "_key" in segment;
}
/** @internal */ function isIndexTuple(segment) {
...
/** @internal */ function isCreateSquashedMutation(mutation) {
    return "createSquashed" in mutation;
}
/** @internal */ function isValidationError(node) {
    return node.level === "error";
}
/** @internal */ function isValidationWarning(node) {
    return node.level === "warning";
}
/** @internal */ function isValidationInfo(node) {
    return node.level === "info";
}
;
}),
"[project]/node_modules/@portabletext/sanity-bridge/node_modules/arrify/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@portabletext/sanity-bridge/node_modules/leven/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function leven(first, second, options) {
    ...
    if (firstLength === 0) {
        return maxDistance !== undefined && secondLength > maxDistance ? maxDistance : secondLength;
    }
    let bCharacterCode;
    let result;
    let temporary;
...
function closestMatch(target, candidates, options) {
    ...
    for (const candidate of candidates){
        ...
        const cap = Number.isFinite(bestDist) ? userMax === undefined ? bestDist : Math.min(bestDist, userMax) : userMax;
        const distance = cap === undefined ? leven(target, candidate) : leven(target, candidate, {
            maxDistance: cap
        });
...
function getSubSchema(schema, of) {
    const blockMember = of.find((member)=>member.type === "block"), blockObjects = of.filter((member)=>member.type !== "block").map((member)=>{
        ...
        if (objectMember.fields === void 0 && objectMember.type !== "object") {
            const declared = schema.blockObjects.find((blockObject)=>blockObject.name === name);
...
//# sourceMappingURL=node_modules_%40portabletext_0ngx31b._.js.map