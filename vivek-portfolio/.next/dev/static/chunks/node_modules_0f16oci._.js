...
"[project]/node_modules/@portabletext/sanity-bridge/node_modules/@sanity/schema/lib/Schema-BckCkziq.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/sanity-bridge/node_modules/arrify/index.js [app-client] (ecmascript)");
...
const FIELD_REF = Symbol.for("@sanity/schema/field-ref"), ruleConstraintTypes = [
    ...
    assetRequired() {
        ...
        return assetType = base && [
            "image",
            "file"
        ].includes(base.name) ? base.name === "image" ? "image" : "file" : "asset", this.cloneWithRules([
            {
                flag: "assetRequired",
                constraint: {
                    assetType
...
const DEFAULT_OVERRIDEABLE_FIELDS = [
    ...
    "initialValue",
    "deprecated"
], OWN_PROPS_NAME = "_internal_ownProps", ALL_FIELDS_GROUP_NAME = "all-fields", DEFAULT_MAX_FIELD_DEPTH = 5, stringFieldsSymbols = {}, getStringFieldSymbol = (maxDepth)=>(stringFieldsSymbols[maxDepth] || (stringFieldsSymbols[maxDepth] = Symbol(`__cachedStringFields_${maxDepth}`)), stringFieldsSymbols[maxDepth]), isReference = (type)=>type.type && type.type.name === "reference", portableTextFields = [
    "style",
    "list"
...
function getStringFieldPaths(type, maxDepth) {
    let reducer = (accumulator, childType, path)=>childType.jsonType === "string" ? [
            ...accumulator,
            path
        ] : accumulator;
...
function getPortableTextFieldPaths(type, maxDepth) {
    let reducer = (accumulator, childType, path)=>isPortableTextArray(childType) ? [
            ...accumulator,
            path
        ] : accumulator;
    return reduceType(type, reducer, [], [], maxDepth);
...
*/ function normalizeMaxDepth(maxDepth) {
    return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isFinite$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(maxDepth) || maxDepth < 1 || maxDepth > 5 ? 4 : maxDepth - 1;
}
...
const OVERRIDABLE_FIELDS$15 = [
    ...
    extend (subTypeDef, extendMember) {
        ...
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(ANY_CORE, OVERRIDABLE_FIELDS$15), ownProps, {
            type: ANY_CORE
        });
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$15), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
    ...
    extend (subTypeDef, createMemberType) {
        let parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(ARRAY_CORE, OVERRIDABLE_FIELDS$14), subTypeDef, {
            type: ARRAY_CORE
        });
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    if (extensionDef.of) throw Error("Cannot override `of` property of subtypes of \"array\"");
                    let ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$14), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
...
function fieldHasReferenceTo(fieldDef, refType) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(fieldDef.to || []).some((memberTypeDef)=>memberTypeDef.type === refType);
}
...
const DEFAULT_LINK_ANNOTATION = {
    ...
    extend (subTypeDef, extendMember) {
        ...
        }, { marks, styles, lists, of, ...rest } = subTypeDef, fields = [
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, INHERITED_FIELDS$1), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, INHERITED_FIELDS), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
...
var primitivePreview_default = {
    prepare: (val)=>({
            title: String(val)
        })
};
const OVERRIDABLE_FIELDS$13 = [
    ...DEFAULT_OVERRIDEABLE_FIELDS
], BOOLEAN_CORE = {
    name: "boolean",
    title: "Boolean",
    ...
    extend (subTypeDef) {
        ...
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(BOOLEAN_CORE, OVERRIDABLE_FIELDS$13), ownProps, {
            type: BOOLEAN_CORE
        });
        return hiddenGetter(parsed, OWN_PROPS_NAME, ownProps), subtype(parsed);
        //TURBOPACK unreachable
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$13), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
...
function buildTitle$2(type) {
    return !type.to || type.to.length === 0 ? "Cross dataset Reference" : `Cross dataset reference to ${humanize$2((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(type.to).map((toType)=>toType.title || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$capitalize$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(toType.type)), "or").toLowerCase()}`;
}
const CrossDatasetReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        let parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(CROSS_DATASET_REFERENCE_CORE, OVERRIDABLE_FIELDS$12), subTypeDef, {
            type: CROSS_DATASET_REFERENCE_CORE
        });
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS$2.map((fieldDef)=>createMemberType.cachedField(fieldDef))), lazyGetter(parsed, "to", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(subTypeDef.to).map((toType)=>({
                    ...toType,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$12), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, ownProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        let ownProps = {
            ...subTypeDef,
            preview: primitivePreview_default
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(DATE_CORE, OVERRIDABLE_FIELDS$11), ownProps, {
            type: DATE_CORE
        });
        return hiddenGetter(parsed, OWN_PROPS_NAME, ownProps), subtype(parsed);
        //TURBOPACK unreachable
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$11), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        let ownProps = {
            ...subTypeDef,
            preview: primitivePreview_default
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(DATETIME_CORE, OVERRIDABLE_FIELDS$10), ownProps, {
            type: DATETIME_CORE
        });
        return hiddenGetter(parsed, OWN_PROPS_NAME, ownProps), subtype(parsed);
        //TURBOPACK unreachable
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$10), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
...
function normalizeSearchConfigs(configs) {
    ...
    return configs.map((conf)=>{
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isPlainObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(conf)) throw Error("Search config must be an object of {path: string, weight: number}");
        return {
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$9);
                    ...
                    let current = Object.assign({}, parent, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$9), {
                        type: parent
                    });
...
function createFieldsets(typeDef, fields) {
    ...
    for (let fieldset of typeDef.fieldsets || []){
        if (fieldsetsByName[fieldset.name]) throw Error(`Duplicate fieldset name "${fieldset.name}" found for type '${typeDef.title ? typeDef.title : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeDef.name)}'`);
...
function createFieldsGroups(typeDef, fields) {
    ...
    for (let group of typeDef.groups || []){
        if (groupsByName[group.name]) throw Error(`Duplicate group name "${group.name}" found for type '${typeDef.title ? typeDef.title : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeDef.name)}'`);
        if (groupsByName[group.name] = {
            ...
            ...group,
            fields: []
        }, group.default && ++numDefaultGroups > 1) throw Error(`More than one field group defined as default for type '${typeDef.title ? typeDef.title : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeDef.name)}' - only 1 is supported`);
    }
    return fields.forEach((field)=>{
        let fieldGroupNames = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$castArray$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(field.group || []);
        fieldGroupNames.length !== 0 && fieldGroupNames.forEach((fieldGroupName)=>{
            let currentGroup = groupsByName[fieldGroupName];
            if (!currentGroup) throw Error(`Field group '${fieldGroupName}' is not defined in schema for type '${typeDef.title ? typeDef.name : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeDef.name)}'`);
            currentGroup.fields.push(field);
        });
    }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$flatMap$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(groupsByName).filter((group)=>group.fields.length > 0 || group.name === "all-fields");
}
const DOCUMENT_CORE = {
    name: "document",
    title: "Document",
    ...
    extend (subTypeDef) {
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$8), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$7), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, ownProps), subtype(current);
                }
...
function buildTitle$1(type) {
    return !type.to || type.to.length === 0 ? "Global Document Reference" : `Global Document Reference to ${humanize$1((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(type.to).map((toType)=>toType.title), "or").toLowerCase()}`;
}
const GlobalDocumentReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        let parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(GLOBAL_DOCUMENT_REFERENCE_CORE, OVERRIDABLE_FIELDS$6), subTypeDef, {
            type: GLOBAL_DOCUMENT_REFERENCE_CORE
        });
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS$1.map((fieldDef)=>createMemberType.cachedField(fieldDef))), lazyGetter(parsed, "to", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(subTypeDef.to).map((toType)=>({
                    ...toType
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$6), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, ownProps), subtype(current);
                }
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    let ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$5), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, ownProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$4), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
...
function buildTitle(type) {
    return !type.to || type.to.length === 0 ? "Reference" : `Reference to ${humanize((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(type.to).map((toType)=>toType.title), "or").toLowerCase()}`;
}
const ReferenceType = {
    get () {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        let parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(REFERENCE_CORE, OVERRIDABLE_FIELDS$3), subTypeDef, {
            type: REFERENCE_CORE
        });
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS.map((fieldDef)=>createMemberType.cachedField(fieldDef))), lazyGetter(parsed, "fieldsets", ()=>createFieldsets(subTypeDef, parsed.fields)), lazyGetter(parsed, "to", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(subTypeDef.to).map((toType)=>createMemberType(toType))), lazyGetter(parsed, "title", ()=>subTypeDef.title || buildTitle(parsed)), lazyGetter(parsed, OWN_PROPS_NAME, ()=>({
                ...subTypeDef,
                fields: parsed.fields,
                fieldsets: parsed.fieldsets,
                to: parsed.to,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    if (extensionDef.of) throw Error("Cannot override `of` of subtypes of \"reference\"");
                    let ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$3), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, ownProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$2), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$1), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, OWN_PROPS_NAME, subOwnProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    let subOwnownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS), current = Object.assign({}, parent, subOwnownProps, {
                        type: parent
                    });
...
"[project]/node_modules/@portabletext/sanity-bridge/node_modules/@sanity/schema/lib/_internal.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/sanity-bridge/node_modules/@sanity/schema/lib/Schema-BckCkziq.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$leven$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/sanity-bridge/node_modules/leven/index.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$groq$2d$js$2f$dist$2f$1$2d$BobtwIDv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__n__as__createReferenceTypeNode$3e$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/sanity-bridge/node_modules/groq-js/dist/1-BobtwIDv.js [app-client] (ecmascript) <export n as createReferenceTypeNode>");
;
;
;
;
...
/** A scheduler which uses an idle callback to process work. */ var IdleScheduler = class {
    #durations = [];
    #lastAwake;
...
/** A scheduler which does the work as synchronous as possible. */ const SYNC_SCHEDULER = {
    async map (arr, fn) {
        return arr.map(fn);
    },
    async forEach (arr, fn) {
...
var DescriptorConverter = class {
	...
	*/ async get(schema, opts) {
        ...
        let builder = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$descriptors$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SetBuilder"]({
            rewriteMap
        });
...
function getOwnProps(schemaType) {
    return "_internal_ownProps" in schemaType ? schemaType[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"]] : schemaType;
}
function convertCommonTypeDef(schemaType, path, opts) {
    ...
    let reason = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(ownProps.deprecated) && "reason" in ownProps.deprecated ? ownProps.deprecated.reason : void 0, orderings;
...
*/ function maybeBlockMarks(schemaType) {
    ...
    if (!spanType || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSpanSchemaType"])(spanType)) return;
    let decorators = convertUnknown(spanType.decorators);
    return decorators === void 0 ? void 0 : {
        decorators
    };
}
...
/** Returns `true` for `true` and undefined for everything else. */ function maybeTrue(val) {
    return val === !0 || void 0;
}
...
function maybeValidations(obj) {
    ...
    let validations = [], rules = Array.isArray(obj.validation) ? obj.validation : [
        obj.validation
    ];
...
function maybeValidation(val) {
    if (val) {
        if (isIRuleFunction(val)) try {
            let result = val(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"]());
...
*/ function createGetItRequester(options) {
    let requester = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getIt"])([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["base"])(options.baseUrl),
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["httpErrors"])(),
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["promise"])({
            onlyBody: !0
        })
    ]);
...
function resolveRequester(options) {
    ...
    if (options.baseUrl !== void 0) return createGetItRequester({
...
const ACTIONS_FLAG = "__experimental_actions", DEFAULT_ACTIONS = [
    ...
    let invalid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$difference$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(actions, VALID_ACTIONS);
...
function createTypeWithMembersProblemsAccessor(memberPropertyName, getMembers = (type)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$get$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(type, memberPropertyName)) {
    return function getProblems(type, parentPath) {
        let currentPath = [
            ...
            return getTypeProblems(memberType, [
                ...currentPath,
                propertySegment
            ]);
        }) : [
...
const arrify = (val)=>Array.isArray(val) ? val : val === void 0 && [] || [
        val
...
function format(value) {
    return Array.isArray(value) ? `array with ${value.length} entries` : typeof value == "object" && value ? `object with keys ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$humanize$2d$list$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(Object.keys(value).map(quote$2))}` : quote$2(value);
}
var array_default = (typeDef, visitorContext)=>{
    ...
    let problems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$flatten$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])([
    ...
    ]), of = ofIsArray ? typeDef.of : [], hasObjectTypesWithoutName = of.some((type)=>type.type === "object" && type.name === void 0);
    ...
    return !isMixedArray && Array.isArray(list) && (primitiveTypes.length > 0 ? list.forEach((option)=>{
        ...
        if (!primitiveTypes.some((primitiveType)=>typeof value === visitorContext.getType(primitiveType.type).jsonType)) {
            let formattedTypeList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$humanize$2d$list$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(primitiveTypes.map((t)=>t.name || t.type), {
                conjunction: "or"
            });
...
function validateBlockType(typeDef, visitorContext) {
    ...
    return disallowedKeys.length > 0 && problems.push(error(`Found unknown properties for block declaration: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$humanize$2d$list$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(disallowedKeys.map(quote$1))}`)), marks &&= validateMarks(typeDef.marks, visitorContext, problems), styles &&= validateStyles(styles, visitorContext, problems), lists &&= validateLists(lists, visitorContext, problems), members &&= validateMembers(members, visitorContext, problems), {
...
function validateStyles(styles, visitorContext, problems) {
    return Array.isArray(styles) ? (styles.forEach((style, index)=>{
        ...
        disallowedKeys.length > 0 && problems.push(error(`Found unknown properties for style ${name}: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$humanize$2d$list$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(disallowedKeys.map(quote$1))}`)), style.value ? typeof style.value == "string" ? style.title || problems.push(warning(`Style ${name} is missing recommended "title" property`)) : problems.push(error(`Style #${index} has an invalid "value" property, expected string, got ${getTypeOf(style.value)}`)) : problems.push(error(`Style #${index} is missing required "value" property`)), style.blockEditor !== void 0 && (problems.push(warning("Style has deprecated key \"blockEditor\", please refer to the documentation on how to configure the block type for version 3.", HELP_IDS.DEPRECATED_BLOCKEDITOR_KEY)), style.component = style.component || style.blockEditor.render);
...
function validateTypeName(typeName, visitorContext) {
    ...
    if (!possibleTypeNames.includes(typeName)) {
        let suggestions = possibleTypeNames.map((possibleTypeName)=>[
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$leven$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeName, possibleTypeName),
                possibleTypeName
            ]).filter(([distance])=>distance < 3).map(([_, name])=>name);
        return [
            error(`Unknown type: ${typeName}.${suggestions.length > 0 ? ` Did you mean ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$humanize$2d$list$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(suggestions.map(quote), {
                conjunction: "or"
            })}?` : ""}`)
        ];
    }
...
function validateField(field, visitorContext) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isPlainObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(field)) return [
        error(`Incorrect type for field definition - should be an object, saw ${inspect_default(field)}`, HELP_IDS.OBJECT_FIELD_DEFINITION_INVALID_TYPE)
    ];
    let problems = [];
...
function validatePreview(preview) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isPlainObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(preview) ? preview.prepare !== void 0 && typeof preview.prepare != "function" ? [
...
var object_default = (typeDef, visitorContext)=>{
    ...
    return initialValue !== void 0 && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isPlainObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(initialValue) && typeof initialValue != "function" && typeDef._problems.push(error("The \"initialValue\" property must be either a plain object or a function")), initialValues !== void 0 && typeDef._problems.push(error("Found property \"initialValues\" - did you mean \"initialValue\"?")), typeDef;
...
*/ function validateSchema(schemaTypes, { transformTypeVisitors = (visitors)=>visitors, transformCommonVisitors = (visitors)=>visitors } = {}) {
    return traverseSanitySchema(schemaTypes, (schemaDef, visitorContext)=>{
        let typeVisitor = schemaDef && schemaDef.type && transformTypeVisitors(typeVisitors)[schemaDef.type] || getNoopVisitor(visitorContext), commonVisitors = transformCommonVisitors([
            common_default
        ]);
...
const builtinSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"].compile({
    name: "studio",
    types: builtinTypes
});
function createSchemaFromManifestTypes(schemaDef) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"].compile({
        name: schemaDef.name,
...
function coerceType(obj) {
    ...
    let typ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$cloneDeep$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(obj);
...
function coerceValidation(val) {
    !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$isObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(val) || !("validation" in val) || (val.validation = (Array.isArray(val.validation) ? val.validation : [
        val.validation
    ]).map((group)=>{
...
. */ function extractManifestSchemaTypes(schema) {
    let typeNames = schema.getTypeNames(), context = {
        schema
    }, studioDefaultTypeNames = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"].compile({
        name: "default",
        types: builtinTypes
    }).getTypeNames();
...
function transformFieldsets(type) {
    ...
    let fieldsets = type.fieldsets?.filter((fs)=>!fs.single).map((fs)=>{
        let options = isRecord(fs.options) ? {
...
function retainSerializableProps(maybeSerializable, depth = 0) {
    if (!(depth > 5) && isDefined(maybeSerializable)) {
        ...
        if (isRecord(maybeSerializable)) {
            let serializableEntries = Object.entries(maybeSerializable).map(([key, value])=>[
                    key,
...
function transformCrossDatasetReference(reference) {
    return {
        to: (reference.to ?? []).map((crossDataset)=>{
            let preview = crossDataset.preview?.select ? {
                preview: {
...
function transformValidation(validation) {
    let validationArray = (Array.isArray(validation) ? validation : [
        validation
    ]).filter((value)=>typeof value == "object" && "_type" in value), disallowedFlags = [
        "type"
    ], disallowedConstraintTypes = [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"].FIELD_REF
...
function ensureCustomTitle(typeName, value) {
    let titleObject = ensureString("title", value), defaultTitle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeName);
...
function getWorkspaceSchemaId(args) {
    ...
    workspaceName.match(validForNamesPattern) || (workspaceName = workspaceName.replace(RegExp(`[^${validForNamesChars}]`, "g"), "_"), idWarning = [
...
*/ function extractSchema(schemaDef, extractOptions = {}) {
	...
	*/ function reserveRefName(refName) {
    ...
    function convertSchemaType(schemaType) {
        ...
        if (isCrossDatasetReferenceType(schemaType) || isGlobalDocumentReferenceType(schemaType)) return {
            type: "unknown"
        };
    ...
    function createReferenceTypeNodeDefintion(reference) {
        ...
        for (let name of references){
            ...
            if (!hoistedRefMap.has(refName)) {
                ...
                inlined && schema.push({
                    type: "type",
                    name: inlined,
                    value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$groq$2d$js$2f$dist$2f$1$2d$BobtwIDv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__n__as__createReferenceTypeNode$3e$__["createReferenceTypeNode"])(name)
                });
            }
        }
        if (references.length === 1) {
            ...
            return inlined ? {
                type: "inline",
                name: inlined
            } : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$groq$2d$js$2f$dist$2f$1$2d$BobtwIDv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__n__as__createReferenceTypeNode$3e$__["createReferenceTypeNode"])(references[0]);
        }
        return {
            type: "union",
            of: references.map((name)=>{
                ...
                return inlined ? {
                    type: "inline",
                    name: inlined
                } : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f$groq$2d$js$2f$dist$2f$1$2d$BobtwIDv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__n__as__createReferenceTypeNode$3e$__["createReferenceTypeNode"])(name);
            })
        };
    }
    return schema;
...
function isFieldRequired(validation) {
    ...
    let rules = Array.isArray(validation) ? validation : [
        validation
    ];
    for (let rule of rules){
        let required = !1, proxy = new Proxy({}, {
...
function hasAssetRequired(validation) {
    ...
    for (let rule of rules){
        let assetRequired = !1, proxy = new Proxy({}, {
...
*/ function validateMediaLibraryAssetAspect(maybeAspect) {
    let errors = groupProblems(validateSchema([
        maybeAspect
    ], {
...
"[project]/node_modules/@portabletext/sanity-bridge/node_modules/@sanity/schema/lib/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/sanity-bridge/node_modules/@sanity/schema/lib/Schema-BckCkziq.js [app-client] (ecmascript)");
;
var _exports_default = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"];
const Schema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$sanity$2d$bridge$2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$Schema$2d$BckCkziq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"];
;
}),
...
//# sourceMappingURL=node_modules_0f16oci._.js.map